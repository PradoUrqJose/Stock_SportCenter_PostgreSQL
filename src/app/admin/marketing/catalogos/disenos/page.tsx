...
export default async function DisenosPage() {
  ...
  return (
    <div className="p-4 md:p-8">
      ...
      <BibliotecaDisenos base={IMAGENES_BASE} plantillas={plantillas} fijas={fijas} marcas={marcas.rows.map((r) => r.marca as string)} enlaces={enlaces} tipos={tipos.map((t) => ({ id: t.id, nombre: t.nombre }))} />
    </div>
  );
}
